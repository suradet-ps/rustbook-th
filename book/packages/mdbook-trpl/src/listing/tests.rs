...
<span class="file-name">ชื่อไฟล์: src/main.rs</span>

````rust
fn main() {}
````

<figcaption><a href="#listing-1-2">ลิสติ้ง 1-2</a>: A write-up which <em>might</em> include inline Markdown like <code>code</code> etc.</figcaption>
</figure>"##
    );
}
...
ลิสติ้ง 1-2: A write-up which *might* include inline Markdown like `code` etc.
...
<figcaption><a href="#listing-34-5">ลิสติ้ง 34-5</a>: This has a <code>Box&lt;T&gt;</code> in it.</figcaption>
</figure>"##
    );
}
...
<span class="file-name">ชื่อไฟล์: main.rs</span>
...
<figcaption><a href="#listing-1-1">ลิสติ้ง 1-1</a>: A program that prints <code>Hello, world!</code></figcaption>
</figure>
...
<figcaption><a href="#listing-1-1">ลิสติ้ง 1-1</a>: This is the caption</figcaption>
</figure>
